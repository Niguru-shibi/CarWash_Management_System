...
<script>
  $(function() {
    function loadServices() {
      $.ajax({
        url: '../../CarWash_Management_System/controller/washplan.php?action=getServices',
        type: 'GET',
        dataType: 'json',
    ...
    $('#addServiceForm').on('submit', function(e) {
      ...
      $.post('../../CarWash_Management_System/controller/washplan.php?action=addService', data, function(res) {
        alert(res.message);
    ...
    $(document).on('click', '.deleteServiceBtn', function() {
      ...
      if (confirm('Are you sure you want to delete this service?')) {
        $.post('/Guerrero/CarWash_Management_System/controller/washplan.php?action=deleteService', {
            serviceId
          },
          function(res) {
            alert(res.message);
    ...
    $(document).on('click', '.editServiceBtn', function() {
      const serviceId = $(this).data('id');
      $.get('/Guerrero/CarWash_Management_System/controller/washplan.php?action=getServices', function(services) {
    ...
    $('#editServiceForm').on('submit', function(e) {
      e.preventDefault();
      const data = $(this).serialize();
      $.post('../../CarWash_Management_System/controller/washplan.php?action=updateService', data, function(res) {
        alert(res.message);
        if (res.status === 'success') {
